...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> pageAppoint(Page<AppointmentVo> appointmentVoPage, AppointmentQueryVo queryVo) {
        return viewAppointmentMapper.pageAppoint(appointmentVoPage,queryVo);
    }
}
